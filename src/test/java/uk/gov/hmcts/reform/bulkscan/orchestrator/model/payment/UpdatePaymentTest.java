...
public class UpdatePaymentTest {
        ...
        void testUpdatePaymentCreation() {
            ...
            uk.gov.hmcts.reform.bulkscan.orchestrator.model.payment.UpdatePayment updatePayment = new uk.gov.hmcts.reform.bulkscan.orchestrator.model.payment.UpdatePayment(
                updatePaymentEntity);
