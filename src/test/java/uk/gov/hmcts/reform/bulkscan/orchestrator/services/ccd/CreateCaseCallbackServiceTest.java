...
class CreateCaseCallbackServiceTest {
    ...
    void should_return_service_case_when_it_already_exists_in_ccd_for_a_given_exception_record()
        ...
        when(ccdCaseCreationManager.tryCreateNewCase(
        ...
        ).thenReturn(new ProcessResult(ImmutableMap.<String, Object>builder()
            .put(CASE_REFERENCE, "345")
            .build()));
    ...
    void should_return_error_if_multiple_cases_exist_in_ccd_for_a_given_exception_record()
        ...
        when(ccdCaseCreationManager.tryCreateNewCase(
            ...
            new ProcessResult(
                emptyList(),
                singletonList("Multiple cases (345, 456) found for the given bulk scan case reference: 123")
            )
        );
