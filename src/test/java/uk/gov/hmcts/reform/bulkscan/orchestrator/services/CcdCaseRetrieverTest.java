...
import static uk.gov.hmcts.reform.bulkscan.orchestrator.SampleData.CCD_AUTH_INFO;
...
public class CcdCaseRetrieverTest {
    ...
    public void should_retrieve_case_successfully() {
        ...
        given(dataApi.readForCaseWorker(USER_TOKEN, SERVICE_TOKEN, USER_ID, JURSIDICTION, CASE_TYPE_ID, CASE_REF))
            .willReturn(THE_CASE);
        given(authenticator.authenticateForJurisdiction(JURSIDICTION)).willReturn(CCD_AUTH_INFO);
